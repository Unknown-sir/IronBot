...
## مدیریت کامل مدیرها + پلن یک‌کانفیگه


در v19.0.17 بخش «👮 مدیریت مدیرها» به پنل ادمین اضافه شده است. مدیرها از داخل ربات فهرست می‌شوند و برای مدیرهای قابل‌حذف دکمه «🗑 حذف» با تأیید دو مرحله‌ای وجود دارد. مدیر اصلی (اولین Chat ID در `ADMIN_CHAT_IDS`)، آخرین مدیر و حساب مدیری که همان لحظه در حال مدیریت است قابل حذف نیستند. حذف مدیر فقط دسترسی مدیریتی او را برمی‌دارد و حساب تلگرام/کاربری عادی او را پاک نمی‌کند.
