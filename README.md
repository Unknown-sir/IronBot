...
**Iron Bot** is a Telegram sales and management bot for **x-ui / 3x-ui** panels. It can sell VPN configurations, manage wallets and orders, create trial configs, work with multiple panels, and deliver configs to users through Telegram.
...
- Plan groups, per-plan price, per-plan duration, and per-plan panel selection
...
sudo chmod +x /opt/watcher2/watcher2_core.py
